        ...
        else
        {
            ...
            if( $page_style == 'style2' )
            {
                ...
                if ($social_show == "true" && $social_show_switch == true)
                {
                    ...
                    $output .=  '       <input type="text" placeholder="'.esc_html__('Social Media', 'listingpro-plugin').'" class="form-control" value="" id="get_media_url">';
                    $output .=  '    </div>';
                    ...
                    if($FaqHasData==true){
                        ...
                        $output .='                                                                            
                                    <div id="tabs-1">
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control" name="faqans[1]" rows="8" placeholder="'.esc_html__("Answer", "listingpro-plugin").'" id="inputDescriptionFaq"></textarea>
                                        </div>
                                </div>';
                    }
                    $output .=  '            </div>';
                    ...
                    if( $b_logo == 1 ) {
                        $output .= '<div class="form-group col-md-12 clearfix margin-bottom-0 margin-top-30 lp-listing-featuredimage lp-featur-st">
										...
										<div class="custom-file">
											...
											<label data-quick-tip="<h2>'. esc_html__( 'Business Logo', 'listingpro-plugin' ) .'</h2><img src='.$quicktip_b_logo.'>" class="b-logo-img-label" for="business_logo"><p>' . esc_html__('Browse', 'listingpro-plugin') . '</p><span>' . esc_html__('Choose a file', 'listingpro-plugin') . '&hellip;</span></label>
										</div>';
                ...
                if ($video_show == "true" || $gallery_show == "true" || lp_theme_option('lp_featured_file_switch') || $b_logo == 1 ){
                    ...
                    if( $b_logo == 1 ):
                        $output .=  '<div class="form-group clearfix margin-bottom-0 margin-top-10 lp-listing-featuredimage lp-featur-st">
										...
										<div class="custom-file">
											<input style="display:none;" type="file" name="business_logo[]" id="business_logo" class="inputfile inputfile-4" />
											<label class="b-logo-img-label" for="business_logo"><p>'.esc_html__('Browse', 'listingpro-plugin').'</p><span>'.esc_html__('Choose a file', 'listingpro-plugin').'&hellip;</span></label>
										</div>
									</div>';
                    endif;
                    $output .='
