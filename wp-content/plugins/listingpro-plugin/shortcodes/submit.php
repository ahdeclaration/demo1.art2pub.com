                    ...
                    if ($b_logo == 1) {
                        $output .= '<div class="form-group clearfix margin-bottom-0 margin-top-10 lp-listing-featuredimage col-md-6">
										...
										<div class="custom-file">
											...
											<label class="b-logo-img-label" for="business_logo" data-quick-tip="<h2>'. esc_html__( 'Business Logo', 'listingpro-plugin' ) .'</h2><img src='.$quicktip_b_logo.'>"><p>' . esc_html__('Browse', 'listingpro-plugin') . '</p><span>' . esc_html__('Choose a file', 'listingpro-plugin') . '&hellip;</span></label>
								</div>
									</div>';
                    }
                    $output .=  ' </div>';
                ...
                if ($video_show == "true" || $gallery_show == "true" || lp_theme_option('lp_featured_file_switch') || $b_logo == 1 ){
                    ...
                    if ($b_logo == 1):
                        $output .= '<div class="form-group clearfix margin-bottom-0 margin-top-10 lp-listing-featuredimage">
										...
										<div class="custom-file">
											<input style="display:none;" type="file" name="business_logo[]" id="business_logo" class="inputfile inputfile-4" />
											<label class="b-logo-img-label" for="business_logo" data-quick-tip="'. esc_html__( 'quick tip for business logo', 'listingpro-plugin' ) .'"><p>' . esc_html__('Browse', 'listingpro-plugin') . '</p><span>' . esc_html__('Choose a file', 'listingpro-plugin') . '&hellip;</span></label>
								</div>
									</div>';
                    endif;
                    $output .= '</div>';
