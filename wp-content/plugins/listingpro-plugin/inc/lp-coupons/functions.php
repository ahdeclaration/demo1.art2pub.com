        ...
        if(!empty($existingCoupon)){
            ...
            if(isset($returnKey)){
                ...
                if(!empty($couponData)){
                    ...
                    $currentDate = date(get_option('date_format'), strtotime($currentDate));
                    $couponStarts = date(get_option('date_format'), strtotime($couponStarts));
                    $couponEnds = date(get_option('date_format'), strtotime($couponEnds));
                    ...
                    if ((strtotime($currentDate) >= strtotime($couponStarts)) && (strtotime($currentDate) <= strtotime($couponEnds))){
                        /* valid date */
                    }else{
                    ...
                    <form name="lp_add_coupon_form" method="POST" action="">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="couponpercentage"
                                   ...
                                   name="couponpercentage" autocomplete="off" required>
                        </div>
                        <div class="form-group col-md-6">
