        ...
        <div class="lp-form-field-options-wrap">
            <div class="form-group col-sm-6 ">
                ...
                <div class="lp-listing-selecter-drop">
                    <select class="form-control select2 submit-field-type" name="field-type"
                            id="field-type">
...
if (!is_admin()) {
                ...
                <div class="form-group col-md-12 col-xs-12">
                    <div id="lp_custom_title" class="tab-pane fade in active">
                        ...
                        <input value="<?php echo $listing_title; ?>"
                               ...
                               type="text" name="postTitle" class="form-control margin-bottom-10 lp-required-field" id="lptitle"
                    ...
                    if (!empty($locations_type) && $locations_type == "auto_loc") {
                        if ($singleLocMode == true) {
                            ...
                            <div class="form-group col-md-12 col-xs-12 lp-new-cat-wrape">
                                ...
                                <input data-quick-tip="<h2><?php echo $atts['tiptitle']; ?></h2><p><?php echo $atts['tipdesc']; ?></p><img src='<?php echo $atts['tipimage']; ?>'>"
                                       value="<?php echo $current_loc; ?>" id="citiess" name="locationn" 
                                       data-isseleted="false" class="form-control ostsubmitSelect <?php  echo $atts['required-class'];  ?>" autocomplete="off"
                            ...
                            if (isset($_GET['lp_post']) && !empty($_GET['lp_post'])) {
                                ...
                                <div class="form-group lp-selected-locs clearfix col-md-12">
                                    ...
                                    <div class="form-group col-md-6 col-xs-12 lp-new-cat-wrape">
                                        <input id="citiess" name="locationn" class="form-control postsubmitSelect <?php  echo $atts['required-class'];  ?>"
                                ...
                                <div class="form-group col-md-12 col-xs-12 lp-new-cat-wrape">
                                    ...
                                    <input id="citiess" name="locationn" data-isseleted="false"
                                           class="form-control ostsubmitSelect <?php  echo $atts['required-class'];  ?>" autocomplete="off"
                                           data-country="<?php echo $locArea; ?>"
                                           placeholder="<?php echo $atts['placeholder']; ?>">
                                </div>
                                <?php
        ...
        function inputWhatsapp($atts)
        {
            ...
            <div class="row">
                ...
                <div class="form-group col-md-12 col-xs-12 ' . $atts['required-class'] . '">
                    ...
                    <input value="' . $whatsapp . '" data-quick-tip="<h2>' . $atts['tiptitle'] . '</h2><p>' . $atts['tipdesc'] . '</p><img src=' . $atts['tipimage'] . '>" type="text" class="form-control ' . $atts['required-class'] . '" name="whatsapp" id="inputWhatsapp" placeholder="' . $atts['placeholder'] . '">
                </div>';
                ?>
            </div>
            <?php
                ...
                <div class="form-group clearfix margin-bottom-0 lp-new-cat-wrape col-md-12 lp-form-builder-enabled">
                    ...
                    if (isset($lp_post) && !empty($lp_post)) {
                        ...
                        if ($singleCatMode == true) {
                            echo '<select data-quick-tip="<h2>' . $atts['tiptitle']. '</h2><p>' . $atts['tipdesc']. '</p><img src=' . $atts['tipimage'] . '>" autocomplete="off" data-placeholder="' . $atts['placeholder'] . '" id="inputCategory" name="category[]" class="select2 postsubmitSelect lp-required-field" tabindex="5">';
                        } else {
                            echo '<select data-quick-tip="<h2>' .  $atts['tiptitle'] . '</h2><p>' . $atts['tipdesc'] . '</p><img src=' . $atts['tipimage'] . '>" autocomplete="off" data-placeholder="' . $atts['placeholder']. '" id="inputCategory" name="category[]" class="select2 postsubmitSelect lp-required-field" tabindex="5" multiple="multiple">';
                        }
                        ...
                        if (!empty($cat_plan_id)) {
                            ...
                            <select data-quick-tip="<h2><?php echo $atts['tiptitle']; ?></h2><p><?php echo $atts['tipdesc']; ?></p><img src='<?php echo $atts['tipimage']; ?>'>"
                                    ...
                                    name="category[]" class="select2 postsubmitSelect lp-required-field" tabindex="5">
                                <?php
                            ...
                            if ($singleCatMode == true) {
                                echo '<select data-quick-tip="<h2>' . $atts['tiptitle'] . '</h2><p>' . $atts['tipdesc'] . '</p><img src=' . $atts['tipimage'] . '>" data-placeholder="' . $atts['placeholder'] . '" id="inputCategory" name="category[]" class="select2 postsubmitSelect lp-required-field" tabindex="5">';
                            } else {
                                echo '<select data-quick-tip="<h2>' . $atts['tiptitle'] . '</h2><p>' . $atts['tipdesc'] . '</p><img src=' . $atts['tipimage'] . '>" data-placeholder="' . $atts['placeholder'] . '" id="inputCategory" name="category[]" class="select2 postsubmitSelect lp-required-field" tabindex="5" multiple="multiple">';
                            }
                            echo '<option value="">' . esc_html__('Select Category', 'listingpro-plugin') . '</option>';
                            $args = array(
                                'post_type' => 'listing',
                ...
                <div class="row">
                    <div class="col-md-4 clearfix">
                        ...
                        if (!isset($lp_post) || empty($lp_post)) {
                            ...
                            ?>
                            <select data-quick-tip="<h2><?php echo $atts['tiptitle']; ?></h2><p><?php echo $atts['tipdesc']; ?></p><img src='<?php echo $firtstImage; ?>'>"
                                    id="price_status" name="price_status"
                                    class="chosen-select chosen-select7  postsubmitSelect <?php echo $atts['required-class']; ?>" tabindex="5">
                        ...
                        if ($atts['pricefrom'] == 'yes') {
                            ...
                            <div class="col-md-4">
                                ...
                                <input value="<?php echo $listingprice; ?>"
                                       ...
                                       type="text" name="listingprice" class="form-control <?php echo $atts['required-class']; ?>" id="listingprice"
                        ...
                        if ($atts['priceto'] == 'yes') {
                            ...
                            <div class="col-md-4">
                                ...
                                <input value="<?php echo $listingptext; ?>"
                                       ...
                                       type="text" name="listingptext" class="form-control <?php echo $atts['required-class']; ?>" id="listingptext"
            ...
            if ($hours_show == "true") {
                ...
                <div class="row">
                    <div data-quick-tip="<h2><?php echo $atts['tiptitle']; ?></h2><p><?php echo $atts['tipdesc']; ?></p><img src='<?php echo $atts['tipimage']; ?>'>"
                         class="form-group clearfix margin-bottom-0 col-md-12 bussin-top <?php if(!empty($atts['required-class'])){echo 'required-business-hours';} ;?>">
                        <?php
                        if (isset($_GET['lp_post']) && !empty($_GET['lp_post'])) {
    ...
    if (!function_exists('socialMedia')) {
        function socialMedia($atts)
        {
            ...
            if ($social_show == "true") {
                ...
                ?>
                <div class="row <?php if(!empty($atts['required-class'])){echo 'required-social-media';} ;?>">
                    <?php
                    if ($twSwitch == 1) {
                            ...
                            <div id="tabs" class="lsiting-submit-faq-tabs clearfix pos-relative" data-faqtitle="<?php echo $listing_faq_text ?>">
                                <div id="tabs-1">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <input data-quick-tip="<h2><?php echo $atts['tiptitle']; ?></h2><p><?php echo $atts['tipdesc']; ?></p><img src='<?php echo $atts['tipimage']; ?>'>"
                                                   type="text" class="form-control <?php echo $atts['required-class']; ?>"
                                        ...
                                        <textarea
                                                data-quick-tip="<h2><?php echo $atts['tiptitle']; ?></h2><p><?php echo $atts['tipdesc']; ?></p><img src='<?php echo $atts['tipimage']; ?>'>" 
                                                class="form-control <?php echo $atts['required-class']; ?>"
                                                placeholder="<?php echo esc_html__('Answer', 'listingpro-plugin'); ?>"
    ...
    if (!function_exists('inputDescription')) {
        function inputDescription($atts)
        {
            ...
            <div class="row">
                <div class="form-group col-md-12 col-xs-12">
                <label for="inputDescription" data-quick-tip="<h2><?php echo $atts['tiptitle']; ?></h2><p><?php echo $atts['tipdesc']; ?></p><img src='<?php echo $atts['tipimage']; ?>'>"><?php echo $atts['label'] ?></label>
                    <?php
                    $edit_settings = array(
                        'editor_class' => 'lp-required-field',
                    );
                    if (isset($lp_post) && !empty($lp_post)) {
                        echo get_textarea_as_editor('inputDescription', 'postContent', $pcontent, $edit_settings);
                    } else {
                        echo get_textarea_as_editor('inputDescription', 'postContent', $atts['placeholder'], $edit_settings);
                    }
                    ?>
                </div>
            </div>
                    ...
                    <div class="form-group col-md-12 col-xs-12 lp-social-area">
                        <div class="form-group col-md-12 col-xs-12" style="padding:0px;">
                            ...
                            if (isset($lp_post) && !empty($lp_post)) {
                                ...
                                ?>
                                <textarea class="form-control <?php echo $atts['required-class']; ?>" data-quick-tip="<h2><?php echo $atts['tiptitle']; ?></h2><p><?php echo $atts['tipdesc']; ?></p><img src='<?php echo $atts['tipimage']; ?>'>" name="tags" id="inputTags"
                                          placeholder="<?php echo $atts['placeholder']; ?>"></textarea>
                                <?php
                            }
                            ?>
                        </div>
            ...
            <div class="form-group clearfix margin-bottom-0 margin-top-10 lp-listing-featuredimage col-md-6">
                ...
                <div class="custom-file">
                    <input style="display:none;" type="file" name="lp-featuredimage[]" id="lp-featuredimage"
                           class="inputfile inputfile-3 <?php echo $atts['required-class']; ?>" data-multiple-caption="{count} files selected"/>
            ...
            <div class="form-group clearfix margin-bottom-0 margin-top-10 lp-listing-featuredimage col-md-6">
                ...
                <div class="custom-file">
                    <input style="display:none;" type="file" name="business_logo[]" id="business_logo"
                           class="inputfile inputfile-4 <?php echo $atts['required-class']; ?>"/>
