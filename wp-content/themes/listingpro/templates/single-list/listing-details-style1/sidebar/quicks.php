		...
		<div class="price-area">
			...
			if($showReport==true && is_user_logged_in() ){ ?>
				<div id="lp-report-listing" class="claim-area">
					...
					<a class="phone-number" data-postid="<?php echo esc_attr( $post->ID ); ?>"  data-reportedby="<?php echo esc_attr( $currentUserId ); ?>" data-posttype="listing" href="#" id="lp-report-this-listing"> <?php echo esc_html__('Report Now!', 'listingpro'); ?></a>		
				</div>
			<?php } ?>
