...
else
{
    ...
    <div class="lp-listing-leadform lp-widget-inner-wrap">
        ...
        <div class="lp-listing-leadform-inner">
            ...
            <form data-lp-recaptcha="<?php echo wp_kses_post( $enableCaptcha ); ?>" data-lp-recaptcha-sitekey="<?php echo esc_attr( $gSiteKey ); ?>" class="form-horizontal hidding-form-feilds margin-top-20"  method="post" id="contactOwner">
