                                        ...
                                        <div class="lp-new-activity-inner <?php echo esc_attr($activiitesclass); ?>">
                                            <div class="clearfix">
                                                ...
                                                <div class="lp-activity-content">
																...
																?>
                                                                   <a href="<?php echo esc_attr($LPlistingURL )?>" target="_blank"><?php echo wp_kses_post($val["rating"]).' '. esc_html__('on a comment by ','listingpro').' '.get_the_author_meta('user_login',$val['reviewer']); ?></a></span>
