                    ...
                    <div class="form-group clearfix  margin-0">
                        ...
                        <div class="select2-dash  col-sm-5 pull-right" style="width: 32%;">
                            ...
                            <div class="discount_displayin_wrap clearfix pull-right">
                                ...
                                <select class="form-control select2" id="event_displayin" data-udi="<?php echo esc_attr($user_id); ?>">
                            ...
                            <div class="lp-listing-outer-container clearfix lp-coupon-outer-container">
                                ...
                                <div class="col-md-3 lp-content-before-after" data-content="<?php esc_html_e('Title','listingpro'); ?>">
                                    ...
                                    <div class="lp-deal-title">
                                        ...
                                        <p title="<?php echo get_the_title( get_the_ID() ); ?>"><?php echo get_the_title( get_the_ID() ); ?></p>

                                        <a href="<?php echo esc_url($currentURL.$perma.$dashQuery.'event-attendees&eid='.get_the_ID()); ?>" class="view-event-attendees" data-eid="<?php echo get_the_ID(); ?>"><?php echo esc_html__( 'View Attendees', 'listingpro' ); ?></a>
                                        ...
                                        <div class="lp-display-inline">
                                            ...
                                            <div class="lp-dot-extra-buttons">
                                                ...
                                                <ul class="lp-user-menu list-style-none">
                                                    ...
                                                    <li><a href="" class="event-edit" data-targetid="<?php echo esc_attr($eID); ?>" data-disID="<?php echo esc_attr($eID); ?>" data-uid="<?php echo esc_attr($user_id); ?>"><i class="fa fa-pencil-square-o"></i><span><?php esc_html_e('Edit','listingpro'); ?></span></a></li>

                                                    <li><a href="#" class="del-this event-del" data-uid="<?php echo esc_attr($user_id); ?>" data-lid="<?php echo esc_attr($eLID); ?>" data-eid="<?php echo esc_attr($eID); ?>" data-targetid="<?php echo esc_attr($eID); ?>"><i class="fa fa-trash-o"></i><span><?php esc_html_e('Delete','listingpro'); ?></span></a></li>
                                ...
                                <div style="display: none;" id="update-wrap-<?php echo esc_attr($eID); ?>">
                                    ...
                                    <div class="panel with-nav-tabs panel-default lp-dashboard-tabs lp-left-panel-height margin-top-40">
                                        ...
                                        <div class="lp-coupns-form-outer">
                                            ...
                                            <div class="lp-voupon-box">
                                                ...
                                                <form class="lp-coupons-form-inner" id="lp-events-form-<?php echo esc_attr($eID); ?>">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-sm-7 col-md-7">
                                                                ...
                                                                <div class="margin-bottom-20">
                                                                    ...
                                                                    <label class="lp-dashboard-top-label" for="event-title-<?php echo esc_attr($eID); ?>"><?php echo esc_html__('Event Name', 'listingpro'); ?></label>

                                                                    <input name="event-title-<?php echo esc_attr($eID); ?>" id="event-title-<?php echo esc_attr($eID); ?>" class="lp-dashboard-text-field form-control" value="<?php echo esc_attr($eTitle); ?>" type="text" placeholder="<?php echo esc_html__('Give it a short quick name', 'listingpro'); ?>">

                                                                </div>

                                                                <div class="">

                                                                    <label class="lp-dashboard-top-label" for="event-description-<?php echo esc_attr($eID); ?>"><?php echo esc_html__('Event Description', 'listingpro'); ?></label>

                                                                    <textarea id="event-description-<?php echo esc_attr($eID); ?>" name="event-description-<?php echo esc_attr($eID); ?>" type="text" class="form-control lp-dashboard-des-field" rows="10" ><?php echo get_the_content(); ?></textarea>
                                                            ...
                                                            <div class="col-sm-5">
                                                                ...
                                                                <div class="jFiler-input-dragDrop pos-relative">
                                                                    ...
                                                                    <input type="hidden" id="event-old-img-<?php echo esc_attr($eID); ?>" value="<?php echo esc_attr($eImg); ?>">

                                                                    <div class="removeable-image upload-field dashboard-upload-field edit-upload-<?php echo esc_attr($eID); ?>">
...

                                                                        {
                                                                            ...
                                                                            <span class="remove-event-img remove-eei" data-targetid="<?php echo esc_attr($eID); ?>">X</span>
                                                                        ...
                                                                        if( !empty( $eImg ) ):
                                                                            ...
                                                                            <img class="lp-uploaded-img event-old-img-<?php echo esc_attr($eID); ?>" src="<?php echo esc_url($eImg); ?>" alt="image">
                                                    ...
                                                    <div class="lp-coupon-box-row">
                                                        ...
                                                        <div class="row margin-bottom-20">
                                                            ...
                                                            <div class="form-group col-sm-6 ">
                                                                ...
                                                                <div class="">
                                                                    ...
                                                                    <label class="lp-dashboard-top-label" for="event-date-s-<?php echo esc_attr($eID); ?>"><?php echo esc_html__('Event Starts', 'listingpro'); ?></label>

                                                                    <input value="<?php if(!empty($eDate)){ echo date( 'M d, Y', $eDate );} ?>" name="event-date-s-<?php echo esc_attr($eID); ?>" id="event-date-s-<?php echo esc_attr($eID); ?>" type="text" class="lp-dashboard-text-field form-control discount-date" placeholder="MM/DD/YYYY">
                                                            ...
                                                            <div class="form-group col-sm-6 ">
                                                                ...
                                                                <div class="">
                                                                    ...
                                                                    <label class="lp-dashboard-top-label" for="event-time-<?php echo esc_attr($eID); ?>"><?php echo esc_html__('Event start Time', 'listingpro'); ?></label>

                                                                    <input value="<?php echo esc_attr($eTime); ?>" name="event-time-<?php echo esc_attr($eID); ?>" id="event-time-<?php echo esc_attr($eID); ?>" type="text" class="lp-dashboard-text-field form-control datetimepicker1" placeholder="<?php echo esc_html__('1:00 am', 'listingpro'); ?>">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-sm-6 ">
                                                                <div class="">
                                                                    <label class="lp-dashboard-top-label" for="event-date-e-<?php echo esc_attr($eID); ?>"><?php echo esc_html__('Event Ends', 'listingpro'); ?></label>
                                                                    <input value="<?php if(!empty($eDateE)){ echo date( 'M d, Y', $eDateE );} ?>" name="event-date-e-<?php echo esc_attr($eID); ?>" id="event-date-e-<?php echo esc_attr($eID); ?>" type="text" class="lp-dashboard-text-field form-control discount-date" placeholder="MM/DD/YYYY">
                                                                </div>
                                                            </div>
                                                            <div class="form-group col-sm-6 ">
                                                                <div class="">
                                                                    <label class="lp-dashboard-top-label" for="event-time-<?php echo esc_attr($eID); ?>"><?php echo esc_html__('Event End Time', 'listingpro'); ?></label>
                                                                    <input value="<?php echo esc_attr($eTimeE); ?>" name="event-time-e-<?php echo esc_attr($eID); ?>" id="event-time-e-<?php echo esc_attr($eID); ?>" type="text" class="lp-dashboard-text-field form-control datetimepicker1" placeholder="<?php echo esc_html__('1:00 am', 'listingpro'); ?>">
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-sm-12 ">
                                                                ...
                                                                <div class="">
                                                                    ...
                                                                    <label for="event-location-<?php echo esc_attr($eID); ?>"><?php echo esc_html__('Address ', 'listingpro'); ?></label>

                                                                    <input value="<?php echo esc_attr($eLoc); ?>" type="text" class="lp-dashboard-text-field form-control event-addr" name="event-location-<?php echo esc_attr($eID); ?>" id="event-location-<?php echo esc_attr($eID); ?>" placeholder="<?php echo esc_html__('e.g. Country, City, Location', 'listingpro'); ?>">

                                                                    <input type="hidden" class="lp-dashboard-text-field latitude" name="latitude" value="<?php echo esc_attr($eLat); ?>">



                                                                    <input type="hidden" class="lp-dashboard-text-field longitude" name="longitude" value="<?php echo esc_attr($eLon); ?>">
                                                    ...
                                                    <div class="lp-coupon-box-row">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <label class="lp-dashboard-top-label" for="event-ticket-url-<?php echo esc_attr($eID); ?>"><?php echo esc_html__('Ticket URL', 'listingpro'); ?></label>

                                                            <div class="event-tickets-list-dash">

                                                                <input id="event-tickets-data-<?php echo esc_attr($eID); ?>" name="event-tickets-data-<?php echo esc_attr($eID); ?>" type="hidden" class="lp-dashboard-text-field form-control" value="<?php echo esc_attr($tUrl); ?>">
                                                                ...
                                                                <ul class="clearfix margin-top-10">
                                                                    ...
                                                                    foreach ( $tUrl_arr as $item )
                                                                    {
                                                                        ...
                                                                        if (isset($item_arr[0]) && isset($item_arr[1])) {
                                                                            ?>
                                                                            <li><strong><?php echo esc_attr($item_arr[0]); ?></strong> <?php echo esc_attr($item_arr[1]); ?> <i class="fa fa-times" data-ticket-platform="<?php echo esc_attr($item_arr[0]); ?>" data-ticket-url="<?php echo esc_attr($item_arr[1]); ?>"></i></li>
                                                                            <?php
                                                                        }
                                                                    }
                                                    ...
                                                    <div class="lp-coupon-box-row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-sm-6 text-right">
                                                                ...
                                                                <button class="lp-save-events lp-coupns-btns" data-eid="<?php echo esc_attr($eID); ?>" data-uid="<?php echo esc_attr($user_id); ?>" class="lp-coupns-btns"><?php echo esc_html__( 'save', 'listingpro' ); ?></button>
                ...
                <form class="lp-coupons-form-inner" id="lp-events-form">
                    ...
                    <div class="lp-coupon-box-row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="lp-listing-selecter-drop">
                                ...
                                echo lp_get_listing_dropdown('event-listing', 'select2-ajax', 'event-listing', 'event_id', 'events');
                    ...
                    <div class="lp-coupon-box-row">
                        ...
                        <div class="form-group events-map-wrap">
                            ...
                            <label class="lp-dashboard-top-label"  for="inputAddress" class="googlefulladdress lp-dashboard-top-label"><?php esc_html_e('Event Location ', 'listingpro'); ?> <span>*</span></label>
                    ...
                    <div class="lp-coupon-box-row event_start_end">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 ">
                                    ...
                                    <div class="pos-relative">
                                        ...
                                        <input name="event-date-s" id="event-date-s" type="text" class="lp-pos-relative-input form-control lp-dashboard-text-field" placeholder="<?php echo esc_html__('Date', 'listingpro'); ?>" autocomplete="off">
                                ...
                                <div class="col-sm-6 ">
                                    ...
                                    <div class="pos-relative" id="time-switch">
                                        ...
                                        <input name="event-time" id="event-time" type="text" class="form-control datetimepicker1 lp-dashboard-text-field lp-pos-relative-input " placeholder="<?php echo esc_html__(' Time', 'listingpro'); ?>" autocomplete="off">
                        ...
                        <div class="lp-invoices-all-stats-on-off coupons-fields-switch clearfix lp-dashboard-switcher padding-0">
                            ...
                            <h5 class="clearfix"> <?php esc_html_e('Set end date ', 'listingpro'); ?>                                  <label class="switch">
                                    ...
                                    <input data-target="date" class="form-control switch-checkbox lp-event-end-date-switch" type="checkbox" checked="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 ">
                                    ...
                                    <div class="pos-relative" id="date-switch">
                                        <span class="lp-field-icon"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                        <input name="event-date-e" id="event-date-e" type="text" class="lp-pos-relative-input form-control lp-dashboard-text-field" placeholder="<?php echo esc_html__('Date', 'listingpro'); ?>" autocomplete="off">
                                ...
                                <div class="col-sm-6 ">
                                    ...
                                    <div class="pos-relative" id="time-switch">
                                        <span class="lp-field-icon"><i class="fa fa-clock-o" aria-hidden="true"></i></span>
                                        <input name="event-time-e" id="event-time-e" type="text" class="lp-pos-relative-input form-control datetimepicker1 lp-dashboard-text-field" placeholder="<?php echo esc_html__('Time', 'listingpro'); ?>" autocomplete="off">
                    ...
                    <div class="lp-coupon-box-row lp-save-btn-container">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12 clarfix">
                                ...
                                <button id="lp-save-events" data-uid="<?php echo esc_attr($user_id); ?>" class="lp-coupns-btns pull-right"><?php echo esc_html__( 'save', 'listingpro' ); ?></button>
