								...
								foreach( $lp_multi_rating_fields as $k => $lp_multi_rating_field )
								{
									...
									<div class="<?php echo esc_attr( $multi_col_class ); ?> padding-left-0">
										<div class="list-style-none form-review-stars">
											...
											<input type="hidden" data-mrf="<?php echo esc_attr( $k ); ?>" id="review-rating-<?php echo esc_attr( $k ); ?>" name="rating-<?php echo esc_attr( $k ); ?>" class="rating-tooltip lp-multi-rating-val" data-filled="fa fa-star fa-2x" data-empty="fa fa-star-o fa-2x" />
