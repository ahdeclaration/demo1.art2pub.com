                            ...
                            <div class="lp-review-right-top">
                                ...
                                <div class="lp-review-stars">
                                    ...
                                    <div class="lp-listing-stars">
                                        ...
                                        <span class="lp-rating-num <?php echo esc_attr( $rating_num_bg ); ?>"><?php echo esc_attr( $rating ); ?><?php if( $rating == 1 || $rating == 2 || $rating == 3 || $rating == 4 || $rating == 5 ){ echo '.0';} ?> </span>
                                ...
                                <div class="lp-deatil-reply-review-area">
                                    <div class="owner-response">
				                        ...
				                        if(!empty($review_reply_time)) { ?>
                                            <time><?php echo esc_attr( $review_reply_time ); ?></time>
				                        <?php } ?>
    ...
    function add_events_cb()
    {
        ...
        else
        {
            if( sanitize_text_field($_POST['eUp']) == 'yes' )
            {
                ...
                if( strtotime($eDate) > strtotime($eDateE) )
                {
                    $return['status']   =   'error';
                        ...
                        <div <?php event_calender_map_atts($event_data); ?> class="events-by-day-wrap" data-ebdt="ebdt-<?php echo esc_attr( $month_day ); ?>">
                            <div class="event-by-day-wrap clearfix">
                                ...
                                if (!empty($event_data['event_img'])) {
                                    ?>
                                    <div class="event-img">
                                        <img src="<?php echo esc_url( $event_data['event_img'] ); ?>">
                                    </div>
                                    <?php
                                }
                                ?>
        ...
        if( $calender_type != 'list' )
        {
            ...
            <div class="month-dates-wrap" style="margin: 20px 0;">
                <div class="week-days-dates-row">
                    ...
                    ?>
                    <?php if ($today_day == $i): ?>
                        <div class="week-day-date-box <?php echo esc_attr( $has_event_class ); ?>"
                             data-todaytime="<?php echo date_i18n( 'd-F-l', $dataStr ); ?>" data-timestr="<?php echo esc_attr( $dataStr ); ?>" data-ewt="ebdt-<?php echo esc_attr( $i ); ?>">

                            <span><?php echo esc_attr( $i ); ?></span></div>
                    <?php else: ?>
                        <div class="week-day-date-box <?php echo esc_attr( $has_event_class ); ?>"
                             data-todaytime="<?php echo date_i18n( 'd-F-l', $dataStr ); ?>" data-timestr="<?php echo esc_attr( $dataStr ); ?>" data-ewt="ebdt-<?php echo esc_attr( $i ); ?>"><span><?php echo esc_attr( $i ); ?></span></div>
                    <?php endif; ?>
                    <?php if (($i + $blank) % 7 == 0):
                    $row_counter++; ?>
                    <div class="clearfix"></div>
                                ...
                                <div class="events-by-day-wrap" data-ebdt="ebdt-<?php echo esc_attr( $ed ); ?>">
                                    <div class="clearfix events-by-day-wrap-classic-con">
                                        <div class="today-event-date-container col-md-6 padding-left-0">
                                            ...
                                            <p class="margin-bottom-0 margin-top-10">Events For <span><?php echo date_i18n('F', $date) . ' ' . $ed ; ?></span><?php //echo esc_attr( $dataStr2 ); ?> </p>
                                        </div>
                                ...
                                for ($xd = $days_processed + 1; $xd <= $daysInMonth; $xd++) {
                                    ...
                                    <div class="events-by-day-wrap" data-ebdt="ebdt-<?php echo esc_attr( $xd ); ?>">
                                        <div class="clearfix events-by-day-wrap-classic-con">
                                            <div class="today-event-date-container col-md-6 padding-left-0">
                                                <span class="close-active-box"><i class="fa fa-times" aria-hidden="true"></i></span>
                                                <p class="margin-bottom-0 margin-top-10"><?php echo esc_html__('Events For', 'listingpro'); ?> <span><?php echo date_i18n('F', $date) . ' ' . $xd ; ?></span><?php //echo esc_attr( $dataStr2 ); ?> </p>
                                            </div>
                        ...
                        foreach ( $events_array as $k => $event_data )
                        {
                            ...
                            <div <?php event_calender_map_atts($event_data); ?> data-ebdt="ebdt-<?php echo esc_attr( $month_day ); ?>" class="event-by-day-wrap clearfix">
                                ...
                                if (!empty($event_data['event_img'])) {
                                    ?>
                                    <div class="event-img">
                                        <img src="<?php echo esc_attr( $event_data['event_img'] ); ?>">
                                    </div>
                                    <?php
                                }
                                ?>                                
            ...
            <div class="list-calendar-inner-wrap">
                <div class="clearfix events-by-day-wrap-classic-con">
                    <div class="today-event-date-container col-md-6 padding-left-0">
                        ...
                        <p class="margin-bottom-0 margin-top-10"><?php echo esc_html__('Events For', 'listingpro'); ?> <span><?php echo date_i18n('F', $date); ?></span><?php //echo esc_attr( $dataStr2 ); ?> </p>
                    </div>
                    <div class="calender-header-switcher col-md-6 padding-right-0">
                        <ul>
                            <li class="col-md-6 text-center show-calander-map"><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo esc_html__('Map View', 'listingpro'); ?></li>
                                    ...
                                    foreach ( $lp_menuee as $lp_menu )
                                    {
                                        ...
                                        <div class="lp-menu-close-outer">
                                            <div class="lp-menu-closed clearfix ">
                                                <div class="row">
                                                    <div class="col-md-6"><i class="fa fa-check-circle fa-check-circle2" aria-hidden="true"></i><h4 class="lp-right-side-title"><span><?php echo esc_html__('Item Name', 'listingpro'); ?></span><br><?php echo esc_attr( $lp_menu['mTitle'] ); ?></h4></div>
                                                    ...
                                                    <ul class="lp-user-menu list-style-none">
                                                        <li><a class="edit-menu-item"
                                                               data-menuID="<?php echo esc_attr( $menu_id ); ?>"
                                                        ...
                                                        <li><a href="" class="menu-del del-this"
                                                               data-LID="<?php echo esc_attr( $lp_menu['mListing'] ); ?>"
                                                               data-targetid="<?php echo esc_attr( $menu_id ); ?>"
                                                               data-uid="<?php echo esc_attr( $user_id ); ?>"><i
                                                                        class="fa fa-trash"
                                            ...
                                            <div id="menu-update-<?php echo esc_attr( $menu_id ); ?>"
                                                ...
                                                <div class="lp-menu-form-inner">
                                                    <form class="row">
                                                                ...
                                                                <div class="row clearfix">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="margin-bottom-20 col-md-8">
                                                                                ...
                                                                                <input name="menu-title-<?php echo esc_attr( $menu_id ); ?>"
                                                                                       id="menu-title-<?php echo esc_attr( $menu_id ); ?>"
                                                                                       type="text"
                                                                                       class="form-control lp-dashboard-text-field"
                                                                                       placeholder="<?php echo esc_html__('Ex: Roasted Chicken', 'listingpro'); ?>"
                                                                                       value="<?php echo esc_attr( $lp_menu['mTitle'] ); ?>">
                                                                            </div>
                                                                            <?php
                                                                            if ($lp_menu['showQute'] == 'false'):
                                                                                ...
                                                                                <div class="menu-price-wrap">
                                                                                    <div class="col-sm-2 padding-left-0">
                                                                                        ...
                                                                                        <input name="menu-old-price-<?php echo esc_attr( $menu_id ); ?>"
                                                                                               id="menu-old-price-<?php echo esc_attr( $menu_id ); ?>"
                                                                                               type="text"
                                                                                               class="form-control lp-dashboard-text-field"
                                                                                               placeholder="<?php echo esc_html__('Ex: $10', 'listingpro'); ?>"
                                                                                               value="<?php echo esc_attr( $lp_menu['mOldPrice'] ); ?>">
                                                                                    </div>
                                                                                    <div class="col-sm-2 padding-left-0">
                                                                                        ...
                                                                                        <input id="menu-new-price-<?php echo esc_attr( $menu_id ); ?>"
                                                                                               name="menu-new-price-<?php echo esc_attr( $menu_id ); ?>"
                                                                                               type="text"
                                                                                               class="form-control lp-dashboard-text-field"
                                                                                               placeholder="<?php echo esc_html__('Ex: $10', 'listingpro'); ?>"
                                                                                               value="<?php echo esc_attr( $lp_menu['mNewPrice'] ); ?>">
                                                                                    </div>
                                                                                </div>
                                                                                <?php
                                                                            else:
                                                                                ...
                                                                                <div class="menu-quote-wrap">
                                                                                    <div class="col-sm-6">
                                                                                        ...
                                                                                        <input id="menu-quote-text-<?php echo esc_attr( $menu_id ); ?>"
                                                                                               type="text"
                                                                                               class="form-control lp-dashboard-text-field"
                                                                                               value="<?php echo esc_attr( $lp_menu['mQuoteT'] ); ?>"
                                                                                    ...
                                                                                    <div class="col-sm-6">
                                                                                        ...
                                                                                        <input id="menu-quote-link-<?php echo esc_attr( $menu_id ); ?>"
                                                                                               type="text"
                                                                                               class="form-control lp-dashboard-text-field"
                                                                                               value="<?php echo esc_attr( $lp_menu['mQuoteL'] ); ?>"
                                                                        ...
                                                                        <div class="margin-bottom-20">
                                                                            ...
                                                                            <textarea
                                                                                    name="menu-detail-<?php echo esc_attr( $menu_id ); ?>"
                                                                                    id="menu-detail-<?php echo esc_attr( $menu_id ); ?>"
                                                                                    type="text"
                                                                                    class="form-control lp-dashboard-des-field"
                                                                                    rows="3"
                                                                                    placeholder="<?php echo esc_html__('Ex: Roasted Chicken', 'listingpro'); ?>"><?php echo esc_attr( $lp_menu['mDetail'] ); ?></textarea>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="jFiler-input-dragDrop pos-relative event-featured-image-wrap-dash">
                                                                            ...
                                                                            <div <?php echo esc_attr( $image_gallery ); ?>
                                                                                    class="upload-field dashboard-upload-field edit-upload-<?php echo esc_attr( $menu_id ); ?>">

                                                                                <input class="frontend-input-multiple"
                                                                                       type="hidden"
                                                                                       id="dis-old-img-<?php echo esc_attr( $menu_id ); ?>"
                                                                                       value="<?php echo esc_attr( $lp_menu['mImage'] ); ?>">
                                                                                        ...
                                                                                        if (strpos($lp_menu['mImage'], ',')) {
                                                                                            ...
                                                                                            foreach ($gallery_arr as $img_url) {
                                                                                                ...
                                                                                                <div class="menu-edit-img-wrap gal-img-count-<?php echo esc_attr( $gal_img_count ); ?>">
                                                                                                        <span data-src="<?php echo esc_attr( $img_url ); ?>"
                                                                                                              data-target="dis-old-img-<?php echo esc_attr( $menu_id ); ?>"
                                                                                                              class="remove-menu-img"><i
                                                                                                                    class="fa fa-close"></i></span>
                                                                                                    <img class="gal-img-count-<?php echo esc_attr( $gal_img_count ); ?> lp-uploaded-img event-old-img-<?php echo esc_attr( $menu_id ); ?>"
                                                                                            ...
                                                                                            <div class="menu-edit-img-wrap gal-img-count-single">
                                                                                                <span data-src="<?php echo esc_attr( $lp_menu['mImage'] ); ?>"
                                                                                                      data-target="dis-old-img-<?php echo esc_attr( $menu_id ); ?>"
                                                                                                      class="remove-menu-img"><i
                                                                                                            class="fa fa-close"></i></span>
                                                                                                <img class="gal-img-count-single lp-uploaded-img event-old-img-<?php echo esc_attr( $menu_id ); ?>"
                                                                                                     src="<?php echo esc_attr( $lp_menu['mImage'] ); ?>"
                                                                                                     alt="image">
                                                                                            </div>
                                                                                            <?php
                                                                                        }
                                                        ...
                                                        <div class="lp-menu-save-btns clearfix col-md-12 margin-bottom-20">
                                                            ...
                                                            <button data-LID="<?php echo esc_attr( $lp_menu['mListing'] ); ?>"
                                                                    data-menuID="<?php echo esc_attr( $menu_id ); ?>"
                                                                    data-uid="<?php echo esc_attr( $user_id ); ?>"
