            ...
            <div id="sidebar-wrapper">
                ...
                <ul class="sidebar-nav clearfix" id="sidebar">
                    ...
                    if( $dashboard_usr_show == true && $booking_dashoard_show == true && class_exists('MedicalPro') ):
                        ?>
                        <li>
                            <a <?php echo $activeMyBookingsMenu; ?> href="<?php echo $currentURL.$perma.$dashQuery.'my-bookings'; ?>">
                                <span class="sub_icon sub_iconfirst"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></span> <?php echo esc_html__('My Bookings', 'listingpro'); ?> <span class="sub_icon sub_iconsecond simptip-position-right simptip-movable" data-tooltip="<?php echo esc_html__('My Bookings', 'listingpro'); ?>"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i></span>
                            </a>
                        </li>
                    <?php endif;
                    if( $dashboard_usr_show == true && $earnings == true && $simpleDashboard == false && class_exists('MedicalPro') ):
                        ?>
                        <li>
                            <a <?php echo $activeEarnings; ?> href="<?php echo $currentURL.$perma.$dashQuery.'earnings'; ?>">
                                <span class="sub_icon sub_iconfirst"><i class="fa fa-usd" aria-hidden="true"></i></span> <?php echo esc_html__('My Earnings', 'listingpro'); ?> <span class="sub_icon sub_iconsecond simptip-position-right simptip-movable" data-tooltip="<?php echo esc_html__('My Earnings', 'listingpro'); ?>"> <i class="fa fa-usd" aria-hidden="true"></i></span>
                            </a>
                        </li>
                    <?php endif;
                            ...
                            <div class="right-panel">
                                <?php if($simpleDashboard==false){ ?>
                                    ...
                                    if(isset($_GET['dashboard']) && !empty($_GET['dashboard'])){
                                        ...
                                        elseif ( esc_html($_GET['dashboard']) == 'manage-booking' && class_exists('MedicalPro') )
                                        {
                                ...
                                if ( esc_html($_GET['dashboard']) == 'my-bookings' && class_exists('MedicalPro') ){
                                    $file = WP_CONTENT_DIR.'/plugins/medicalpro/templates/dashboard/'.esc_html($_GET['dashboard']).'.php';
                                    require ($file);
                                }elseif ( esc_html($_GET['dashboard']) == 'earnings' && class_exists('MedicalPro') ){
                                    $file = WP_CONTENT_DIR.'/plugins/medicalpro/templates/dashboard/'.esc_html($_GET['dashboard']).'.php';
                                    require ($file);
                                }
