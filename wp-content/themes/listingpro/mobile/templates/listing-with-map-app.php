					...
					<div class="search-filter-attr-filter-outer">
						...
						if(!empty($priceOPT) && $priceOPT=='1'){
							...
							<div class="form-group pricy-form-group margin-right-0">
								...
								<div class="currency-signs search-filter-attr " id="search-filter-attr-filter">
									<ul>
										<li class="simptip-position-top simptip-movable" data-tooltip="<?php echo esc_html__( 'Inexpensive', 'listingpro' );?>"><a id="one" href="#" data-price="inexpensive"><?php echo wp_kses_post($lp_priceSymbol); ?></a></li>
										<li class="simptip-position-top simptip-movable" data-tooltip="<?php echo esc_html__( 'Moderate', 'listingpro' );?>"><a id="two" href="#" data-price="moderate"><?php echo wp_kses_post($lp_priceSymbol2); ?></a></li>
										<li class="simptip-position-top simptip-movable" data-tooltip="<?php echo esc_html__( 'Pricey', 'listingpro' );?>"><a id="three" href="#" data-price="pricey"><?php echo wp_kses_post($lp_priceSymbol3); ?></a></li>
										<li class="simptip-position-top simptip-movable" data-tooltip="<?php echo esc_html__( 'Ultra High End', 'listingpro' );?>"><a id="four" href="#" data-price="ultra_high_end"><?php echo wp_kses_post($lp_priceSymbol4); ?></a></li>
									</ul>
								</div>
							</div>
						<?php } ?>
								  ...
								  <div class="location-filters location-filters-wrapper">
								   ...
								   <div id="pac-container" class="clearfix">
									<div class="clearfix row">
									 <div class="lp-price-range-btnn col-md-1 col-xs-1 text-right padding-0"><?php echo esc_attr($minRange); ?></div>
									 ...
									 <div class="col-md-2 col-xs-2 padding-0 text-left lp-price-range-btnn"><?php echo esc_attr($maxRange); ?></div>
						...
						if(!empty($openTimeOPT) && $openTimeOPT=='1'){
							...
							<div class="search-filters form-group margin-right-0">
								<ul>
									<li class="listing_openTime"><a href="#" data-time="close"><i class="fa fa-clock-o"></i><?php echo esc_html__( 'Open Now', 'listingpro' );?></a></li>
								</ul>
							</div>
						<?php } ?>
