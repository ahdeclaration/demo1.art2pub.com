                                    ...
                                    foreach (NextendSocialLogin::$providers AS $provider){
                                        ...
                                        <li>
                                            <a id="logingoogle" class="google flaticon-googleplus"
                                               ...
                                               onclick="window.location = '<?php echo get_site_url(); ?>/wp-login.php?loginSocial=google&redirect='+window.location.href; return false;">
                                        ...
                                        <li>
                                            <a id="loginfacebook" class="facebook flaticon-facebook"
                                               ...
                                               onclick="window.location = '<?php echo get_site_url(); ?>/wp-login.php?loginSocial=facebook&redirect='+window.location.href; return false;">
                                                <span class="lp-pop-icon-img"><img
