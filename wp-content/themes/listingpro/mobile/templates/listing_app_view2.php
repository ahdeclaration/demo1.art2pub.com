                        ...
                        <div id="coup-<?php echo get_the_ID(); ?>" class="lp-listing-bottom-right">
                            ...
                            <?php  
                                ...
                                <div class="archive-countdown-wrap">
                                    <div id="lp-deals-countdown<?php echo esc_attr($coup_count); ?>" class="lp-countdown lp-deals-countdown<?php echo esc_attr($coup_count); ?>"
                        ...
                        <div class="col-xs-6">
                            ...
                            if( $lp_multi_rating_fields )
                            {
                                ...
                                foreach ( $lp_multi_rating_fields as $k => $v )
                                {
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="<?php echo esc_attr($rating_field_val_percent); ?>"
                                             aria-valuemin="0" aria-valuemax="100" style="width:<?php echo esc_attr($rating_field_val_percent); ?>%">
                                        </div>
                                    </div>
                                    <?php
                                }
                            ...
                            <div class="price-area">
                                ...
                                if($showReport==true && is_user_logged_in() ){ ?>
                                    <div id="lp-report-listing" class="claim-area">
                                        ...
                                        <a class="phone-number" data-postid="<?php echo get_the_ID(); ?>"  data-reportedby="<?php echo esc_attr($currentUserId); ?>" data-posttype="listing" href="#" id="lp-report-this-listing"> <?php echo esc_html__('Report Now!', 'listingpro'); ?></a>
                                                            ...
                                                            foreach ( $listing_menu as $lp_menu ):
                                                                ...
                                                                <div class="lp-listing-appview-menu-item <?php if( $menu_counter == $total_menus ){ echo 'last-item'; } ?>">
                                                                    ...
                                                                    <div class="lp-menu-item-thumb">
                                                                        ...
                                                                        <?php endif; ?>
                                                                        <a href="<?php echo esc_url($img_url_full); ?>" rel="prettyPhoto[mgallery<?php echo esc_attr($menu_counter); ?>]"><img src="<?php echo esc_url($img_url); ?>"></a>

                                                                    </div>

                                                                    <div class="lp-menu-item-detail">

                                                                        <a <?php if( $lp_menu['mLink'] ): echo 'href="'. esc_url($lp_menu['mLink']) .'"'; endif; ?> class="lp-menu-item-title"><?php echo esc_attr($lp_menu['mTitle']); ?></a>
                        ...
                        if( !empty($listingGAdsense) ){ ?>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <?php echo wp_kses_post($listingGAdsense); ?>
                                </div>
                            </div>
                        <?php }
                    }
